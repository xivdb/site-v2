...
output('XIVSync Auto Update Free Companies');
...
output('Starting update, range: %s > %s', [
	($start * AUTO_UPDATE_FC_MAX),
	($start * AUTO_UPDATE_FC_MAX) + AUTO_UPDATE_FC_MAX
]);
(new Sync\Tasks\TaskAddFreeCompanyMembers())->init($start);
